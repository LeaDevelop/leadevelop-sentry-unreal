...
private:
    ...
    // @LeaDevelop customization --- START
	/** Formats raw map name into user-friendly level name */
	FString FormatLevelName(const FString& RawMapName) const;
	// @LeaDevelop customization --- END
