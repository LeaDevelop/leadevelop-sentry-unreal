...
struct FTagsPromotion
{
	...
	// @LeaDevelop customizations
	UPROPERTY(Config, EditAnywhere, BlueprintReadWrite, Category = "General",
	Meta = (DisplayName = "Changelist", ToolTip = "Flag indicating whether the engine changelist number should be promoted to a captured event's tag."))
	bool bPromoteChangelist = false;
	
	// @LeaDevelop customizations
	UPROPERTY(Config, EditAnywhere, BlueprintReadWrite, Category = "General",
	Meta = (DisplayName = "Level name", ToolTip = "Flag indicating whether the current level name (Editor/PIE/Game with map name) should be promoted to a captured event's tag."))
	bool bPromoteLevelName = false;

	// @LeaDevelop customizations
	UPROPERTY(Config, EditAnywhere, BlueprintReadWrite, Category = "General",
	Meta = (DisplayName = "Engine version", ToolTip = "Flag indicating whether the engine version should be promoted to a captured event's tag."))
	bool bPromoteEngineVersion = false;
};
